/** Icon name → SVG path `d` attribute mapping for quick action pills. */
export const ICON_REGISTRY: Record<string, string> = {
  "chart-bar": "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
  "arrows-compare": "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4",
...
export function getIconPath(iconName: string | null): string {
  return ICON_REGISTRY[iconName || DEFAULT_ICON] || ICON_REGISTRY[DEFAULT_ICON];
}
